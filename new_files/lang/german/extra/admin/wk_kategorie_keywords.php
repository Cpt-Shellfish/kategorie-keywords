...
define('MODULE_WK_KATEGORIE_KEYWORDS_INCLUDE_TPL_ORIG', ' <br />Die mit * gekennzeichneten Template Dateien liegen im Original vor und k&ouml;nnen mit dem Inhalt der modifizierten Versionen (Pr&auml;fix "wkkk") &uuml;berschrieben werden (alternativ: Umbenennen von Original und modifizierter Version):<br />');
...
define('MODULE_WK_KATEGORIE_KEYWORDS_SHOW_DESC', 'Listing der erfassten Kategorien &uuml;ber dem Suchergebnis');
